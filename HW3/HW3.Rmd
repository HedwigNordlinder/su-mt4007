...
Now we need to fix the "k, M, B" problem and add "missing" when an entry is missing (instead of null). If we have an NA value we replace it with -1, to give a numerical identification to future users of the data that that cell was suspicious
